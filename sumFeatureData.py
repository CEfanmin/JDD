...
# active_ability = pd.Series(raw_data['click_count_sum'])/4.0
#
# order_ability.to_csv('./order_ability.csv')
# loan_ability.to_csv('./loan_ability.csv')
# repayment_ability.to_csv('./repayment_ability.csv')
# active_ability.to_csv('./active_ability.csv')
